...
CREATE TABLE `scheduled_execution` (
  `scheduled_execution_id` bigint NOT NULL AUTO_INCREMENT,
  ...
  KEY `environment_id_fk_se` (`environment_id`),
  CONSTRAINT `environment_id_fk_se` FOREIGN KEY (`environment_id`) REFERENCES `environment` (`environment_id`)
